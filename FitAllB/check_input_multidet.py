...
#                self.fit['skip'].append(i+1)
    ...
    def set_start(self): # build fcn, initiate minuit and set starting values and errors
        ...
        self.param['tilt_x1_error'] = 0.001
        self.param['tilt_y1_error'] = 0.001
        self.param['tilt_z1_error'] = 0.001
        self.param['y_size1_error'] = 0.1
        self.param['z_size1_error'] = 0.1
        self.param['y_center1_error'] = 0.1
        self.param['z_center1_error'] = 0.1
        self.param['distance1_error']  = 10.
        self.param['tilt_x2_error'] = 0.001
        self.param['tilt_y2_error'] = 0.001
        self.param['tilt_z2_error'] = 0.001
        self.param['y_size2_error'] = 0.1
        self.param['z_size2_error'] = 0.1
        self.param['y_center2_error'] = 0.1
        self.param['z_center2_error'] = 0.1
        self.param['distance2_error']  = 10.
        # grain errors
        for i in range(self.no_grains):
...
def set_globals(inp):
        ...
        inp.values['tz0'] = deepcopy(inp.param['tilt_z'])
        inp.values['py0'] = deepcopy(inp.param['y_size'])
        inp.values['pz0'] = deepcopy(inp.param['z_size'])
        ...
        try:
            ...
            inp.values['tz1'] = deepcopy(inp.param['tilt_z1'])
            inp.values['py1'] = deepcopy(inp.param['y_size1'])
            inp.values['pz1'] = deepcopy(inp.param['z_size1'])
            inp.values['cy1'] = deepcopy(inp.param['y_center1'])
            inp.values['cz1'] = deepcopy(inp.param['z_center1'])
            inp.values['L1']  = deepcopy(inp.param['distance1'])
        except:
            pass
        try:
        ...
        try:
            ...
            inp.values['py2'] = deepcopy(inp.param['y_size2'])
            inp.values['pz2'] = deepcopy(inp.param['z_size2'])
            inp.values['cy2'] = deepcopy(inp.param['y_center2'])
            inp.values['cz2'] = deepcopy(inp.param['z_center2'])
        ...
        inp.errors['tz0'] = deepcopy(inp.param['tilt_z_error'])
        inp.errors['py0'] = deepcopy(inp.param['y_size_error'])
        inp.errors['pz0'] = deepcopy(inp.param['z_size_error'])
...
def copy_globals(inp):
        ...
        # global values, detector specific, NB list can be extended to more than 3 detectors
        inp.param['tilt_x'] = deepcopy(inp.values['tx0']) 
        inp.param['tilt_y'] = deepcopy(inp.values['ty0']) 
        inp.param['tilt_z'] = deepcopy(inp.values['tz0']) 
        inp.param['y_size'] = deepcopy(inp.values['py0']) 
        inp.param['z_size'] = deepcopy(inp.values['pz0']) 
        ...
        # global errors, detector specific, NB list can be extended to more than 3 detectors
        inp.param['tilt_x_error'] = deepcopy(inp.errors['tx0']) 
        inp.param['tilt_y_error'] = deepcopy(inp.errors['ty0']) 
        inp.param['tilt_z_error'] = deepcopy(inp.errors['tz0']) 
        inp.param['y_size_error'] = deepcopy(inp.errors['py0']) 
        inp.param['z_size_error'] = deepcopy(inp.errors['pz0']) 
